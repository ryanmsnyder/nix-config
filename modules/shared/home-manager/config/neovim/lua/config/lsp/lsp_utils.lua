...
function M.set_keys(client, buffer)
	...
	wk.add({
		{ "<C-k>", vim.lsp.buf.signature_help, desc = "LSP signature help", mode = { "n", "i" } },
		...
		{ "<leader>c", group = "Code" },
		{ "<leader>ct", utils.toggle_diagnostics, desc = "Toggle diagnostics" },
		{ "<leader>cr", vim.lsp.buf.rename, desc = "Rename" },
		{ "<leader>ca", vim.lsp.buf.code_action, desc = "Code action", mode = { "n", "v" } },
		{ "<leader>cf", M.format, desc = "Format document", cond = cap.documentFormatting },
		{ "<leader>cf", M.format, desc = "Format range", cond = cap.documentRangeFormatting, mode = "v" },
